...
public class IPForAddressUtil {
    ...
    public static Map<String, Object> getAddresses(String content, String encodingString) {
        // 这里调用百度API
        String urlStr = "http://api.map.baidu.com/location/ip?ak=bQ0Z1HuOtKATWHXsca7TqdhEZjrj1E08&ip="+content+"&coor=bd09ll";
    ...
    public static void main(String[] args) throws Exception {
        Map<String, Object> addresses = IPForAddressUtil.getAddresses("222.137.210.39", "UTF-8");
